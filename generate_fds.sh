...
# Run generation.
python lstm_generate_book.py -em 5 -l 2 -n 200 -N 1833 -S softmax -T 0.05 -E 1 -b 5 -t 0.2 -D results/wuthering-em5-nhu200 data/wuthering.txt results/wuthering-em5-nhu200/list_098 results/${raw_output}
